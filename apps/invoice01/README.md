...
> 📚 **This repository is a tutorial.** Each chapter under `apps/` builds the app up one step further, so they stay separate applications over one shared core. This is the `invoice01` chapter (invoicing on top of `delegation01`).

## 🚀 Live Demo

- **This chapter (invoice01)**: https://invoice01.le-space.de
- **Previous chapter (delegation01)**: https://delegation01.le-space.de
- **Main app**: https://simple-todo.le-space.de

The custom-domain links track the current deployment of each chapter.
