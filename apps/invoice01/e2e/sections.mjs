...
/**
 * Open one section of the page through its tab (invoice01).
 *
 * The page opens on the todos and keeps the invoices, the lists and the network
 ...
 * @param {'aufgaben' | 'rechnungen' | 'listen' | 'netzwerk'} section
 */
